...
/* CLIENTE*/
insert into CLIENTE (CIUDAD_ID, CLIENTE_NOMBRE, CLIENTE_APELLIDOS, CLIENTE_CEDULA, CLIENTE_TELEFONO, CLIENTE_CORREO, CLIENTE_CALLE, CLIENTE_CODE_POSTAL, CLIENTE_DESCRIPCION) 
